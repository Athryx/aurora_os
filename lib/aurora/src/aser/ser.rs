...
pub fn to_bytes<T: Serialize>(data: &T, num_capabilties: usize) -> Result<Vec<u8>, AserError> {
    let mut serializer = Serializer::new(num_capabilties);
...
const CAP_NEWTYPE_NAME: &str = "__aser_cap";
...
struct CapabilitySerializer<'a>(&'a mut Serializer);

impl<'a> serde::Serializer for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeSeq for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeTuple for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeTupleStruct for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeTupleVariant for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeMap for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeStruct for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
...
impl<'a> ser::SerializeStructVariant for &'a mut CapabilitySerializer<'_> {
    type Ok = ();
    type Error = AserError;
